...
class TakeCoverEnv(gym.Env):
    def __init__(self, render=False, config_path='./surprise/envs/vizdoom/scenarios/take_cover.cfg', vae=False, god=True, respawn=True, num_actions=2):
